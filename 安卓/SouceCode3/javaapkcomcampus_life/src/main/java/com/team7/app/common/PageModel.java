...
import com.team7.app.entity.Message;
...
public class PageModel<T> implements Serializable {
	...
	public static PageModel<ItemList> jsonConvert(String json){//json���ݸ�ʽת����pmģ��
	...
	public static PageModel<Message> jsonConvertMsg(String json){//json���ݸ�ʽת����pmģ��
