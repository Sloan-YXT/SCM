...
import com.team7.app.adapter.ShopListAdapter;
...
import com.team7.app.common.PageModel;
import com.team7.app.entity.ItemList;
import com.team7.app.entity.Users;
import com.team7.app.service.MyApplication;
import com.team7.app.view.PullDownView;
import com.team7.app.view.PullDownView.UpdateHandler;
...
public class MyCollectionActivity extends Activity implements UpdateHandler {
	...
	public void loadData( int pn) {
		getLayoutInflater().inflate(R.layout.progress_dialog, null,
				false);
		HashMap<String, Object> params = new HashMap<String, Object>();
		Log.e("Post","pageNo:"+pn);
		params.put("pageNo", pn);
		params.put("username", string);
		if(string == null)
		{
			Log.e("Post","string = null");
		}
		else
		{
			Log.e("Post","String = "+string);
		}
		if (pageNo == 1) {
			listDatas.clear();
		...
		Log.e("action","before data");
		Log.e("action",Constants.URL+ "/second-hand/collect_list.do");
		Log.e("action",params.toString());
		//params = null;
