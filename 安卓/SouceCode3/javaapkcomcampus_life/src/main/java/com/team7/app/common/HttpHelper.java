...
import com.team7.app.campus_life.ShopInfoActivity;
...
//	public static String post(String url, HashMap<String, Object> params,String content)
//			throws AppException {
//		HttpPost post = getHttpPost(url);
//		if (null != params) {
//			List<NameValuePair> pairList = new ArrayList<NameValuePair>();
...
//		return str;
//	}
//	public static void asyncPost(final String url,final String content,
//								 final HashMap<String, Object> params, final Callback callback) {
//		final Handler handler = new Handler() {
//			@Override
//			public void handleMessage(Message msg) {
...
//				try {
//
//					String str = post(url, params,content);
//					msg.obj = str;
//				} catch (AppException e) {
//					Log.e("Post",Log.getStackTraceString(e));
//
