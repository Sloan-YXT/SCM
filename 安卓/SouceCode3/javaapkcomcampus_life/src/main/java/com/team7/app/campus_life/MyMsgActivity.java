...
import com.team7.app.adapter.MessageAdapter;
...
public class MyMsgActivity extends Activity implements UpdateHandler{
	...
	private List<com.team7.app.entity.Message> listDatas = new ArrayList<com.team7.app.entity.Message>();
		...
		HttpHelper.asyncPost(Constants.URL + "/second-hand/msg_list.do",
				params, new Callback() {
					...
					public void dataLoaded(Message msg) {
						...
						PageModel<com.team7.app.entity.Message> pm = PageModel.jsonConvertMsg(json);
